        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_RETURN:
                    ...
                    pygame.draw.line(WIN, (0, 255, 0), (coordenadas_inicio[0], coordenadas_inicio[1]), (coordenadas_final[0], coordenadas_final[1]), 2)
                    for i, ciudad in enumerate(secuencia):
                        if i < len(secuencia)-1:
                            ...
                            pygame.draw.line(WIN, (0, 255, 0), (coordenadas_uno[0], coordenadas_uno[1]), (coordenadas_dos[0], coordenadas_dos[1]), 2)
